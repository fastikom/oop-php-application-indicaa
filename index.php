...
<body>
	...
	<div align="center" class="style1">
		...
		<table width="914" border="0" align="center">
			<tr>
			<td colspan="5"> <a href="input.php"><img src="input.png"/></a> </td>
			</tr>
			<tr>
...
?>
			<tr>
				...
				<td bgcolor="#FFFFFF">
					<div align="center">
						<a href="edit.php?id=<?php echo $x['id']; ?>&aksi=edit"><img src="edit.png"/></a>
						<a href="proses.php?id=<?php echo $x['id']; ?>&aksi=hapus"><img src="hapus.png"/></a>	        
					</div>
				</td>
			</tr>
<?php 
